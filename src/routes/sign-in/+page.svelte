<script lang="ts">
	...
	import GoogleIcon from '$lib/components/authicons/google.svelte'
	import GitHubIcon from '$lib/components/authicons/github.svelte'
...
<svelte:head>
	...
	<meta name="og:image" content="/images/twitter_opengraph_light.png" />
	...
	<meta
		name="twitter:image"
		content="/images/twitter_opengraph_light.png"
	/>
</svelte:head>
